...
import 'package:lessons106/utils/utils.dart';
    ...
    return Row(
      children: [
        ClipRRect(
          ...
          child: const Image(
            image: AssetImage("asssets/images/chicken_curry.png"),
            width: 150,
            height: 150,
            fit: BoxFit.cover,
          ),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      SvgPicture.asset("asssets/svg/clock.svg"),
                      const Text(
                        "45min",
                        style: TextStyle(
                          color: AppColors.redPinkMain,
                  ...
                  Row(
                    children: [
                      ...
                      SvgPicture.asset("asssets/svg/difficulty.svg"),
                    ],
                  ),
                  Row(
                    children: [
                      ...
                      SvgPicture.asset("asssets/svg/star.svg"),
                    ],
                  ),
                ],
              ),
